...
**via rolhama** (concentrador bddphp → ollama de slot único; não colide com os outros
consumidores). NÃO vai pra Hostinger (lá só a `api/`).
...
#    ROLHAMA_BDD_URL, ROLHAMA_BDD_KEY, ROLHAMA_CHANNEL=505, ROLHAMA_OLLAMA_MODEL=qwen2.5:14b-instruct
# 4. serviço
...
Canal 505 = o do bddphp reservado ao KDD (o rolhama atende 500-510; hacker usa 502/503/504).
